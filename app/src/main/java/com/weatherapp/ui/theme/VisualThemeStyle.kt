...
internal val beigeTokens = WeatherColorTokens(
    ...
    verdictText       = Color(0xFFF5E8A8),   // lighter amber — ~7:1
...
internal val utilityTokens = WeatherColorTokens(
    ...
    secondaryText     = Color(0xCC4ADE80),   // 80% opacity — passes WCAG AA
...
internal val eightBitTokens = WeatherColorTokens(
    ...
    secondaryText     = Color(0xFF9BBC0F),  // lightest Game Boy green — best achievable in this palette
