...
object WeatherDesignTokens {
    ...
    val clearLight = WeatherColorTokens(
        ...
        topZoneBackground = Color(0xFFBBDEFB),
    ...
    val clearDark = WeatherColorTokens(
        ...
        topZoneBackground = Color(0xFF1E4080), // bright blue — clearly distinct from cardBackground
    ...
    val overcastLight = WeatherColorTokens(
        ...
        cardBackground  = Color(0xFFFFFFFF),
        topZoneBackground = Color(0xFFD0D0E8),
    ...
    val overcastDark = WeatherColorTokens(
        ...
        topZoneBackground = Color(0xFF30286E), // deep purple — clearly distinct from cardBackground
    ...
    val rainLight = WeatherColorTokens(
        ...
        topZoneBackground = Color(0xFFCFD8DC),
    ...
    val rainDark = WeatherColorTokens(
        ...
        topZoneBackground = Color(0xFF1A3A50), // blue-grey — clearly distinct from cardBackground
    ...
    val stormLight = WeatherColorTokens(
        ...
        topZoneBackground = Color(0xFFBDBDBD),
    ...
    val stormDark = WeatherColorTokens(
        ...
        topZoneBackground = Color(0xFF252D38), // slate blue — clearly distinct from cardBackground
